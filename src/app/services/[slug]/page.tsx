...
export default async function ServicePage({
  ...
  return (
    <>
      ...
      <section className="relative bg-kemnay-black overflow-hidden" style={{ minHeight: "55vh" }}>
        {/* Background image */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center" style={{ minHeight: "55vh", paddingTop: "6rem", paddingBottom: "4rem" }}>
          {/* Breadcrumbs */}
